...
<body>
  ...
  <header class="container w-full bg-white sticky-header">
    <div class="container">
      <div class="flex items-center justify-between">
        ...
        <!-- ACTIONS -->
        <div x-data="{search:''}" class="flex items-center xs:gap-5 md:gap-7 ms-auto">
          <!-- SEARCH -->
          <form action="#" class="hidden lg:block shrink-0" method="GET">
            <input type="search" class="py-2 rounded-full form-input" name="search" x-model="search" placeholder="Search...">
          </form>
          <!-- WISH LIST -->
          <!-- CART LIST -->
          ...
          <?php if ($previousEmail === null) { ?>
            <div class="flex items-center gap-4 shrink-0">
              <a href="./database/user/login.php" aria-label="Log in"
              ...
              <a href="./database/user/signup.php" aria-label="Registration"
          ...
          <?php } else { ?>
            <a href="./database/user/logout.php" aria-label="Registration"
